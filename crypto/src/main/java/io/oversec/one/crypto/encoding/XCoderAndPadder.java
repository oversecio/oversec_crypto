...
public class XCoderAndPadder {
    ...
    public synchronized String encode(Outer.Msg msg, String srcText, boolean appendNewLines) throws Exception {
        return mCoder.encode(msg, mPadder, srcText, appendNewLines);
    }
