 ...
 * which has a bug.
 *
 * We still need to verify such incorrect MACs from older clients,
 * so that's why we need this class.
 *
 * This also has intentionally been left as java.
 */
public class Poly1305_asof_BC_1_54
    implements Mac
{
     ...
     */
    public Poly1305_asof_BC_1_54(final BlockCipher cipher)
    {
    ...
    private void setKey(final byte[] key, final byte[] nonce)
    {
        ...
        Poly1305KeyGenerator_asof_BC_1_54.checkKey(key);
